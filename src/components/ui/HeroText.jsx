    ...
    <div className="flex flex-col justify-center items-center mt-18 md:mt-0 gap-8">
      ...
      <div>
        <div className="md:max-w-5xl text-center">
          <span className="text-white md:font-extrabold md:leading-15 leading-12 font-bold text-[48px] md:text-6xl ">
            Transforming Concepts into Seamless{" "}
          </span>{" "}
          <span className="text-[#CBACF9] md:leading-18 leading-12 font-bold text-[48px] md:font-extrabold md:text-6xl">
            User Experiences
          </span>
        </div>
        <div></div>
