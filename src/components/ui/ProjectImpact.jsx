    ...
    <div className="mb-12 sm:mb-16 lg:mb-20">
      <div className="text-center mb-8 sm:mb-10 lg:mb-12">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#CBACF9]/10 to-[#38BDF8]/10 border border-[#CBACF9]/20 rounded-full px-4 py-2 mb-6">
          ...
          <span className="text-[#CBACF9] tracking-wide text-sm font-medium">Impact Analysis</span>
        </div>
        <h2 className="text-2xl sm:text-3xl lg:text-4xl tracking-wide font-bold bg-gradient-to-r from-white to-[#CBACF9] bg-clip-text text-transparent mb-3 sm:mb-4">
      ...
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full">
                  ...
                  <div className="relative bg-gradient-to-r from-[#0F1419] to-[#1A1B3A] border border-[#CBACF9]/15 rounded-lg p-4 hover:border-[#CBACF9]/25 transition-all duration-300">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#C1C2D3] text-xs sm:text-sm font-medium">{metric.label}</span>
                      </div>
                      <span className="text-[#CBACF9] font-bold text-base sm:text-lg group-hover/item:text-white transition-colors duration-300">{metric.value}</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="group relative">
          ...
          <div className="relative bg-gradient-to-br from-[#0C0E23] to-[#161A31] border border-[#363749] rounded-xl sm:rounded-2xl p-6 sm:p-8 h-full hover:border-green-500/30 transition-all duration-500 group-hover:shadow-lg group-hover:shadow-green-500/10">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-green-500/60 to-emerald-500/60 rounded-lg flex items-center justify-center shadow-sm shadow-green-500/10">
                <Trophy size={16} sm:size={18} className="text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white">
                Achievements
              </h3>
              ...
              {impact?.outcomes.map((outcome, index) => (
                <div key={index} className="group/item">
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-gradient-to-r from-white/5 to-white/8 border border-white/8 hover:border-green-500/15 transition-all duration-300">
                    ...
                    <p className="text-[#C1C2D3] text-xs sm:text-sm leading-relaxed group-hover/item:text-white transition-colors duration-300">{outcome}</p>
                  </div>
                </div>
              ))}
            </div>
